package com.angelocyj.bodypart.view.AnimatedPathView;
    ...
    private void getFromAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            if (a != null) {
                ...
                mPaint.setColor(a.getColor(R.styleable.PathView_pathColor, 0xff00ff00));
...
//                canvas.restoreToCount(count);
            ...
            for (int i = 0; i < count; i++) {
                ...
                // draw circle
                canvas.drawCircle(regions[i].getStartX(), regions[i].getStartY(), 4, mPaint);
    ...
    public static class AnimatorBuilder {
         ...
         */
        public AnimatorBuilder(final AnimatedPathView pathView) {
